...
BUILDUSER := `whoami`
LDFLAGSSTRING :=-X github.com/jskinfu123/lightwalletd/common.Version=$(VERSION)
LDFLAGSSTRING +=-X github.com/jskinfu123/lightwalletd/common.GitCommit=$(GITCOMMIT)
LDFLAGSSTRING +=-X github.com/jskinfu123/lightwalletd/common.Branch=$(BRANCH)
LDFLAGSSTRING +=-X github.com/jskinfu123/lightwalletd/common.BuildDate=$(BUILDDATE)
LDFLAGSSTRING +=-X github.com/jskinfu123/lightwalletd/common.BuildUser=$(BUILDUSER)
